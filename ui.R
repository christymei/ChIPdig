shinyUI(pageWithSidebar(
  ...
  mainPanel(
    tabsetPanel(id = "inTabset",
      ...
      tabPanel(title = "Initial processing of mapped reads", value = "initial_proc", uiOutput('text8'), tableOutput('data_frame_processing_example'),uiOutput("sample_list_title"), tableOutput('sample_list'),uiOutput("sample_list_with_parameters_title"),tableOutput('sample_list_with_parameters'),uiOutput("chrom_sizes_title"),tableOutput('chrom_sizes'),uiOutput("MDS_all_title"),plotOutput('MDS_all', width = "65%"),downloadButton('MDS_all_download', 'Download plot')),
